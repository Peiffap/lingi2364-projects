...
def train_and_evaluate(minsup, database, subsets, top_K):
    ...
    dt = tree.DecisionTreeClassifier(criterion="entropy", class_weight='balanced', max_depth=6)

    classifier = dt # Creating model object
...
if __name__ == '__main__':
    # example1()
    if len(sys.argv) == 1:
        example2("../statement/data/molecules.pos", "../statement/data/molecules.neg")
    else:
        example2()